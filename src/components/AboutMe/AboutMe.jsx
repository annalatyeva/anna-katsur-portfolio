...
<p>With over a decade of experience, I specialize in elevating brand presence and engagement in the IT and fintech sectors. My professional journey includes leading over 50 successful advertising campaigns and spearheading significant redesign and rebranding initiatives for major corporations.</p><br></br>
...
<div className={aboutmeStyle.media}>
  ...
  <div className={aboutmeStyle.medialinks}>
    <a className={aboutmeStyle.link} href="https://my.epicgrowth.io/programs/rebranding">[REBRANDING PROGRAM]</a>
    <a className={aboutmeStyle.link} href="https://promo.sber.ru/design#">[SBER DESIGN PROMO]</a>
    <a className={aboutmeStyle.link} href="https://hackernoon.com/a-checklist-of-changes-that-await-us-in-the-field-of-arts?fbclid=IwAR24mtEBPt_c-uE0Sn_i-RFCDxtXLD2JEa8e0KqNTi7X-hCVBdawCalCowU">[CHANGES IN THE FIELD OF ARTS]</a>
    <a className={aboutmeStyle.link} href="https://filmdaily.co/lifestyle/art-and-illusion-a-study-on-the-role-of-neural-networks-in-the-work-of-anna-katsur">[ART AND ILLUSION STUDY]</a>
    <a className={aboutmeStyle.link} href="https://techbullion.com/the-synthesis-of-painting-and-ml-technologies-in-the-world-of-nft">[SYNTHESIS OF PAINTING AND ML TECHNOLOGIES]</a>
    </div>
</div>
    </div>
  );

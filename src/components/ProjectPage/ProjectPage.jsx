    ...
    return (
        ...
        <div className="project">
            ...
            <div className='project-gallery'>
                <img className='project-gallery__item' src="https://images.ctfassets.net/hrltx12pl8hq/28ECAQiPJZ78hxatLTa7Ts/2f695d869736ae3b0de3e56ceaca3958/free-nature-images.jpg?fit=fill&w=1200&h=630" alt="" style={{width: "35%"}}/>
                <img  className='project-gallery__item'src="https://images.unsplash.com/photo-1587129792339-b94591f3d74d?w=420&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXRodW1ibmFpbHx8ODYyMTk4fHxlbnwwfHx8fHw%3D" alt="" style={{width: "15%"}}/>
                <img  className='project-gallery__item' src="https://images.unsplash.com/photo-1587129792339-b94591f3d74d?w=420&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXRodW1ibmFpbHx8ODYyMTk4fHxlbnwwfHx8fHw%3D" alt="" style={{width: "15%"}}/>
                <img  className='project-gallery__item' src="https://images.unsplash.com/photo-1587129792339-b94591f3d74d?w=420&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXRodW1ibmFpbHx8ODYyMTk4fHxlbnwwfHx8fHw%3D" alt="" style={{width: "15%"}}/>
            </div>
            <div className='project-article'>
                <section>In the 1960s outer space has become a collective dream of humankind. Contemporaries of Yuri Gagarin, Neil Armstrong, and generations to follow read and watch science fiction, fantasizing about extraterrestrial journeys. Our dreams got more earthly since, but the cosmos still remains a synonym of continuous elaboration and progress.</section>
                <section>
            ...
            <div className='project-switch'>
                <h4>Art Direction for the Rebranding of the Fin-Tech Product Ecosystem</h4>
                <p>/</p>

	...
	return (
		<div className="project-container">
			...
			<div className="project-gallery__wrapper b23">
				<ReactPlayer url="https://player.vimeo.com/video/941363731?h=e774d2e59e" className="project-gallery__item" muted={true} playing={true} loop={true} playsInline={true} width="100%" height="100%" />
			</div>
			...
			<div className="project-gallery4">
				...
				<img className="project-gallery__img item_vertical" src={galleryItem2} alt="" width="100%" height="100%" />
			...
			<div className="project-gallery4">
				<img className="project-gallery__img item_horizontal" src={galleryItem9} alt="" width="100%" height="100%" />
				...
				<img className="project-gallery__img item_horizontal" src={galleryItem6} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
			...
			<div className="project-gallery__logo">
				<img className="project-gallery__img item_horizontal3" src={galleryItem8} alt="" width="100%" height="100%" />
			</div>

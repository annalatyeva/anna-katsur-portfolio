	...
	return (
		<div className="project-container">
			...
			<div className="project-gallery__wrapper">
				<ReactPlayer url="https://player.vimeo.com/video/862109483?h=6fd26ffd5d&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
			</div>
			...
			<div className="project-gallery">
				<div className="project-gallery__wrapper item_horizontal">
					<ReactPlayer url="https://player.vimeo.com/video/870069354?h=91642a8795&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
				<div className="project-gallery__wrapper item_horizontal">
					<ReactPlayer url="https://player.vimeo.com/video/862075633?h=91642a8795&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
			</div>
			<div className="project-article">
			...
			<div className="project-gallery">
				<div className="project-gallery__wrapper item_vertical">
					<ReactPlayer url="https://player.vimeo.com/video/870061329?badge=0&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
				<div className="project-gallery__wrapper item_vertical">
					<ReactPlayer url="https://player.vimeo.com/video/862318538?h=4ea0f25798&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
				<div className="project-gallery__wrapper item_horizontal">
					<ReactPlayer url="https://player.vimeo.com/video/862129417?h=42ab2fd2e8&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
			</div>
			<div className="project-article">
			...
			<div className="project-gallery">
				...
				<div className="project-gallery__wrapper item_horizontal">
					<ReactPlayer url="https://player.vimeo.com/video/871822571?h=ad9f8e895c&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
				<div className="project-gallery__wrapper item_horizontal">
					<ReactPlayer url="https://player.vimeo.com/video/871804706?h=c56d51ec06&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} loop={true} width="100%" height="100%" />
				</div>
			</div>
			<div className="project-article">

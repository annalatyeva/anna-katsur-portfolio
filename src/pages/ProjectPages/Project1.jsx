		...
		<div className="project-container">
			...
			<div className="project-gallery2">
				...
				<div className="project-gallery__wrapper item_horizontal b6">
					<ReactPlayer url="https://player.vimeo.com/video/769945605?h=93f114d52f&badge=0&background=1&quality=1080&autopause=0&player_id=0&app_id=58479" className="project-gallery__item" playing={true} playsInline={true} loop={true} width="100%" height="100%" />
				</div>
			</div>

        ...
        <section className="project4-article__item1">
          <h6 className="project-article__title">
			...
			<div className="project-gallery4">
				...
				<img className="project-gallery__img item_horizontal" src={galleryItem7} alt="" width="100%" height="100%" />
				<img className="project-gallery__img item_vertical" src={galleryItem8} alt="" width="100%" height="100%" />
				<img className="project-gallery__img item_vertical" src={galleryItem9} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project4-article__item1">
					...
					<p className="project4-article__text">To be used in the symbol and in the wordmark elements of the Logo.</p>
				</section>
			</div>
			...
			<div className="project-article">
				<section className="project4-article__item1">
					...
					<p className="project-article__subtitle">SBER Heritage Green</p>
					<p className="project4-article__text">To be used for Logo, as a background for layouts, for texts. Also can be applied for uniform and merchandising solutions.</p>
					<p className="project-article__subtitle">SBER Mass Segment Gradient</p>
					<p className="project4-article__text">To be used for Time element, as a background for layouts, in typography, for icons filling.</p>
					<p className="project-article__subtitle">SBER Deep Ocean, SBER Snow</p>
					<p className="project4-article__text">To be used as a background for layouts, in typography. Also can be applied for uniform and merchandising solutions.</p>
					<p className="project-article__subtitle">SBER Sunshine</p>
					<p className="project4-article__text">To be used as an accent colour in typography.</p>
					...
					<p className="project4-article__text">To be used in typography and as a background colour.</p>
				</section>
			</div>
			<div className="project-gallery__logo">
				<img className="project-gallery__img" src={galleryItem11} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project4-article__item1">
					<p className="project-article__subtitle">SBER Mass segment gradient</p>
					<p className="project4-article__text">The gradient consists of two colors: SBER Herbal and SBER Sky. To be used for Time element, as a background for layouts, in typography, for icons filling.</p>
				</section>
			</div>
			<div className="project-gallery__logo">
				<img className="project-gallery__img" src={galleryItem12} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project4-article__item1">
					<h6 className="project-article__title">Time element</h6>
					<p className="project4-article__text">The bright gradient adds freshness and shows the movement of time. An additional dynamics is added by the offset circle of the dial, which can also be moved depending on the layout, the only condition is the contact of more part of the circle and gradient zone so that they work as one image.</p>
				</section>
				<section className="project-article__item2">
					<p>The start of the time is set by the stylistically designed arrow of the clock on one side of the time interval. It duplicates the gradient from the sign of the logo in full color layouts, but can also be monochrome for different types of application.</p>
				</section>
			</div>
			<div className="project-gallery4">
				<img className="project-gallery__img item_vertical" src={galleryItem13} alt="" width="100%" height="100%" />

    ...
    <div className="project-container">
      ...
      <div className="project-article">
        ...
        <section className="project-article__item2">
          <p>
            The font traditionally resides in the lower, invisible part of the
            iceberg. Users notice or think about the font less frequently, even
            though it permeates the entire design system. In fact, we see fonts
            constantly, but usually do not pay attention to them. Nevertheless,
            the choice and character of a font significantly affect the
            perception of information and convey much on a subconscious level.
          </p>
        </section>
      </div>
      ...
      <div className="project-article">
        <section className="project4-article__item1">
          I oversaw the development of the new Sber super headset, which
          includes a comprehensive toolkit for all the communication and service
          tasks of the company, ensures user comfort, and also the individuality
          and recognisability of the brand across any platform and channel.
        </section>
        <section className="project-article__item2">
          <h6 className="project-article__title">
            SB Sans Text / Composition of the Typeface System
          </h6>
          <p>
            Grotesques — a collective name for sans-serif typefaces. In England
            and France, they are often called Sans Serif, in America Gothic, and
            in Germany Grotesk. The first known grotesque appeared in England in
            1816 in the type samples of London typefounder William Caslon IV
            (1780–1869).
          </p>
          <p>
            Typically, grotesques have main and connecting strokes of almost the
            same thickness (non-contrasting) or with a barely noticeable
            difference in stroke thickness (low-contrast).
          </p>
        </section>
      </div>
      ...
      <div className="project-article">
        <section className="project4-article__item1">
          The bank has many digital products and ATMs with low-resolution
          screens. SB Sans Interface is designed for interface elements on
          websites and in mobile applications. The regular style of SB Sans
          Interface is slightly narrower than SB Sans Text, but it is
          better optimised for use at small sizes
        </section>
      </div>
      <div className="project-gallery__logo">
        <img
      ...
      <div className="project3-article">
        <section className="project4-article__item1">
          ...
          <p className="project4-article__text">
            Specially for developers, we have designed the monospaced styles of
            SB Sans Mono, which are convenient for coding, formatting tables,
            and in all cases where full column width alignment and consistent
            character positioning across different lines are required
          </p>
        </section>
      </div>
      <div className="project-gallery">
      ...
      <div className="project-article">
        <section className="project-article__item2">
          <p>
            ...
            on paper, rather than displayed on screen. SB Sans Display differs
            from the Text range in the proportions of the characters, the
            terminations of the strokes, and some other details
          </p>
        </section>
      </div>
      <div className="project-gallery__logo">
      ...
      <div className="project3-article">
        <section className="project4-article__item1">
          ...
          <p className="project4-article__text">
            The SB Serif Text fonts are primarily designed for use in print,
            formatting small text (9–18 pt) for extended reading
          </p>
        </section>
      </div>
      <div className="project-gallery__logo">

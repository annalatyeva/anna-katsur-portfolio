	...
	return (
		<div className="project-container">
			<div className="project-header">
				<h2 className="project2-header__title">DEVELOPMENT OF SBER'S CORPORATE TYPEFACE SYSTEM</h2>
			...
			<div className="project-article">
				<section className="project-article__item1">If you imagine branding as an iceberg, then the visible part would include the logo, symbol, and corporate colour. However, the entire iceberg—that is, branding—is not just the most obvious part, but a complex system.</section>
				...
				<section className="project-article__item2">
					<p>The font traditionally resides in the lower, invisible part of the iceberg. Users notice or think about the font less frequently, even though it permeates the entire design system. In fact, we see fonts constantly, but usually do not pay attention to them. Nevertheless, the choice and character of a font significantly affect the perception of information and convey much on a subconscious level.</p>
				</section>
			</div>
			...
			<div className="project-article">
				<section className="project4-article__item1">I oversaw the development of the new Sber super headset, which includes a comprehensive toolkit for all the communication and service tasks of the company, ensures user comfort, and also the individuality and recognisability of the brand across any platform and channel.</section>
				<section className="project-article__item2">
					<h6 className="project-article__title">SB Sans Text / Composition of the Typeface System</h6>
					<p>Grotesques — a collective name for sans-serif typefaces. In England and France, they are often called Sans Serif, in America Gothic, and in Germany Grotesk. The first known grotesque appeared in England in 1816 in the type samples of London typefounder William Caslon IV (1780–1869).</p>
					<p>Typically, grotesques have main and connecting strokes of almost the same thickness (non-contrasting) or with a barely noticeable difference in stroke thickness (low-contrast).</p>
				</section>
			</div>
			<div className="project-gallery">
				<img className="project-gallery__img" src={galleryItem3} alt="" width="100%" height="100%" />
				<img className="project-gallery__img" src={galleryItem4} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project4-article__item1">The bank has many digital products and ATMs with low-resolution screens. SB Sans Interface is designed for interface elements on websites and in mobile applications. The regular style of SB Sans Interface is slightly narrower than SB Sans Text, but it is better optimised for use at small sizes</section>
			</div>
			<div className="project-gallery__logo">
				<img className="project-gallery__img" src={galleryItem5} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project4-article__item1">
			...
			<div className="project-gallery__logo">
				<img className="project-gallery__img" src={galleryItem6} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project4-article__item1">
			...
			<div className="project-gallery">
				<img className="project-gallery__img" src={galleryItem7} alt="" width="100%" height="100%" />
				<img className="project-gallery__img" src={galleryItem8} alt="" width="100%" height="100%" />
			</div>
			<div className="project-article">
				<section className="project-article__item2">
			...
			<div className="project-gallery">
				<img className="project-gallery__img item_horizontal" src={galleryItem11} alt="" width="100%" height="100%" />
				<img className="project-gallery__img item_horizontal" src={galleryItem12} alt="" width="100%" height="100%" />
			...
			<Link to="/project04" className="project-switch__link">
				<div className="project-switch">
					<h4 className="project-switch__title">DEVELOPMENT OF AN ACCESSORIES COLLECTION</h4>
